...
- [multi-root-workspace.md](./multi-root-workspace.md) — upstream-unmodified design for Multi-root Workspace: provider replacement + subclassing.
  - Implemented (M1/M2/M3/M4): composition, scope resolution, both providers, the topology snapshot, the root registry / command / panel, and the cross-process Authority Lease.
