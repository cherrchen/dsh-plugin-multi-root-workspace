...
export const zh = {
  ...
  'panel.title': '工作区目录',
  'panel.subtitle': '主工作目录始终可写；附属工作目录与它同权，但可以随时增删。',
  'panel.primary': '主工作目录',
...
export const en = {
  ...
  'panel.subtitle': 'The primary working directory is always writable; secondary working directories are its equals, and can be added or removed at any time.',
